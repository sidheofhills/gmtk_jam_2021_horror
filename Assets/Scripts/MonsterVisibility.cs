...
public class MonsterVisibility : MonoBehaviour
{
    ...
    private List<LampLight> LampListMaker()
    {
        ...
        Debug.Log(chosenLampList + " in " + monsterTransform.gameObject.name);
    ...
    private void VisibilityChanger()
    {
        ...
        curScaleValFitted = Mathf.Lerp(0.1f, 1, Mathf.InverseLerp(gameData.startingScale, gameData.deathScale, monsterTransform.localScale.x));
        ...
        private void OnEnable()
    {
        ...
        monsterTransform = this.gameObject.transform;
